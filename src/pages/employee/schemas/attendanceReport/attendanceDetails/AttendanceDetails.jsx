...
import { Row, Col, Avatar, Flex, DatePicker, Table, Spin, Button, } from 'antd'
...
const AttendanceDetails = () => {
  ...
  const onPresent = () => { setTableName("Presents"), setTypeReport("Present") }
  const onAbsent = () => { setTableName("Absents"), setTypeReport("Absent") }
  const onTravel = () => { setTableName("Official Travels"), setTypeReport("Official Travel") }
