...
const AttendanceConfiguration = () => {
  ...
  const onCancleEnableLocation = () => {
    setOpenEnableLocation(false);
  }

  const onOkAddPhoto = () => {
    setOpenAddPhoto(false);
    setOpenSubmitAttendance(true);
  }

  const onCancleAddPhoto = () => {
    setOpenAddPhoto(false);
  }

  const onOkSubmitAttendance = () => {
    setOpenSubmitAttendance(false);
    setOpenSuccessModal(true);
  }

  const onCancleSubmitAttendance = () => {
    setOpenSubmitAttendance(false);
  }
  ...
  return (
    <>
      ...
      <center>
        <div className="date-bar">
          ...
          <div className='attendance'>
            <center>
              {/* Image */}
              {/* <img src={StartAttendance} alt="Start Attendance" style={{ width: "100%", }} /> */}
              <Image src={StartAttendance} preview={false} width={230} />

              <p>Start my attendance today</p>

              <Button className='attendance-button' onClick={startAttendance} >
      ...
      <SuccessModal action="Check in" isModalOpen={openSuccessModal} handleOk={onOkSuccessModal} handleCancle={onCancleSuccessModal} />
    </>
  )
}
