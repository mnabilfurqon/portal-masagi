        ...
        <Form.Item>
            <Modal centered open={props.openEnableLocation} onOk={props.onOkEnableLocation} onCancel={props.onCancelEnableLocation} footer={<div></div>}>
                <center>
                    ...
                    <Button className='attendance-button' onClick={props.onOkEnableLocation}>Enable location</Button>
                </center>
            </Modal>
        </Form.Item>
          ...
          <Modal centered title="Add Photo" open={props.openAddPhoto} onOk={props.onOkAddPhoto} onCancel={props.onCancelAddPhoto} footer={<div></div>}>
            <center>
              ...
              <Flex gap={10} align='center' justify='center' >
                <Avatar src='https://xsgames.co/randomusers/avatar.php?g=pixel&key=1' shape='circle' size={80} />
                <Avatar src='https://xsgames.co/randomusers/avatar.php?g=pixel&key=2' shape='circle' size={100} />
                <Avatar src='https://xsgames.co/randomusers/avatar.php?g=pixel&key=3' shape='circle' size={80} />
              </Flex>
              <p style={{ marginTop: 20, marginBottom:20, color: "#556172", }}>Use camera to upload your recent attendance photo</p>
              <Button className='attendance-button' onClick={props.onOkAddPhoto}>
